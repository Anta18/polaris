          ...
          <div className="mb-10">
            ...
            {query && (
              <div className="flex items-center gap-3 flex-wrap">
                <p className="text-base text-gray-400">Showing results for</p>
          ...
          {loading ? (
            ...
            <div className="text-center py-20 bg-zinc-900 rounded-lg border border-zinc-800">
              ...
              <p className="text-base text-gray-400 mb-2">
                Use the search bar above to find news articles by topic, author,
                or keyword.
              </p>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {/* Left Column */}
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-b from-blue-500/20 via-blue-500/5 to-transparent rounded-2xl blur-xl"></div>
                  <div className="relative bg-gradient-to-b from-zinc-900 to-black rounded-2xl border-2 border-blue-500/40 p-6 space-y-6">
                    {leftArticles.length === 0 ? (
                      <div className="text-center py-16 bg-zinc-800/50 rounded-lg border border-blue-500/20">
                ...
                {/* Center Column */}
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-b from-emerald-500/20 via-emerald-500/5 to-transparent rounded-2xl blur-xl"></div>
                  <div className="relative bg-gradient-to-b from-zinc-900 to-black rounded-2xl border-2 border-emerald-500/40 p-6 space-y-6">
                    {centerArticles.length === 0 ? (
                      <div className="text-center py-16 bg-zinc-800/50 rounded-lg border border-emerald-500/20">
                ...
                {/* Right Column */}
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-b from-rose-500/20 via-rose-500/5 to-transparent rounded-2xl blur-xl"></div>
                  <div className="relative bg-gradient-to-b from-zinc-900 to-black rounded-2xl border-2 border-rose-500/40 p-6 space-y-6">
                    {rightArticles.length === 0 ? (
                      <div className="text-center py-16 bg-zinc-800/50 rounded-lg border border-rose-500/20">
